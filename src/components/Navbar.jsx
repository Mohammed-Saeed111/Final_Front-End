...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
      ...
      {/* Logo */}
      <span className='text-2xl font-bold text-primary'>Atman Clinic</span>
...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
      ...
      {/* الشعار */}
      {/* <img onClick={() => navigate('/')} className='w-44 cursor-pointer' alt="Atman Clinic" /> */}
       <span className='text-2xl font-bold text-primary'>Atman Clinic</span>
...
=======
        ...
        {/* قائمة التنقل الخاصة بالهواتف المحمولة */}
        <div className={`md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all ${showMenu ? 'fixed w-full' : 'h-0 w-0'}`}>
          <div className='flex items-center justify-between px-5 py-6'>
            <img className='w-36' src={assets.logo} alt="logo" />
            <img className='w-7 cursor-pointer' onClick={() => setShowMenu(false)} src={assets.cross_icon} alt="close" />
